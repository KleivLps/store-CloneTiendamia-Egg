...
function printCart() {
    ...
    <div class="product-price">
        P.U. S/ ${product.price}.00 <br>
        --------------- <br>
     Subtotal S/ ${product.price * product.quantity}.00
    </div>
    `;
...
function printTotal() {
    ...
    <h1 class="cart-title">Resumen del pedido</h1>
        <p class="cart-total">Total        S/${(totalPrice !== null || totalPrice !=0) ? totalPrice : 0 }</p>
        <p class="cart-tax">Precio incluye I.G.V</p>
